@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->hasPages())
                <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between text-gray-200">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
                        <span class="px-4 py-2 bg-gray-800 border border-gray-700 rounded">Prev</span>
                    @else
                        <a href="{{ $paginator->previousPageUrl() }}" class="px-4 py-2 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded">Prev</a>
                    @endif
                    ...
                    @if ($paginator->hasMorePages())
                        <a href="{{ $paginator->nextPageUrl() }}" class="px-4 py-2 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded">Next</a>
                    @else
                        <span class="px-4 py-2 bg-gray-800 border border-gray-700 rounded">Next</span>
                    @endif
                </nav>
            @endif
        </div>
